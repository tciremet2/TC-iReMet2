function [distance] = Set_SamplingQconstraint_experiment2(x, Prob)
	...
	% load inputvariables
	%load Set_SamplingQconstraint_experiment2.mat
    load Set_SamplingQconstraint_experiment2_2.mat
	...
	% calculate distance 
    distance = x' * F * x + [OptInput2.d;0]' * x + OptInput2.const_add;
