function [distance] = Set_SamplingQconstraint_experiment3(x, Prob)
	...
	% load inputvariables
	%load Set_SamplingQconstraint_experiment3.mat
    load Set_SamplingQconstraint_experiment3_2.mat
	...
	% calculate distance 
    distance = x' * F * x + [OptInput3.d;0]' * x + OptInput3.const_add;
