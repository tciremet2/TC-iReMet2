% CP script to calculate transcript ratios mean and sdev
% this will be ulgy hardcode 

clear;
clc;

%%%% USE THIS FOR WT TO MT WTMT RATIO
%{
%%% FIRST TABLE 
% read in table
ratio_e1 = readtable('WTMT_ratio_mets_0d1d7d21d_e1.csv');
% save names
metnames = ratio_e1(:,1);
summarynames = {'wt_mt_0d_e1_meanratio','wt_mt_0d_e1_sdev',...
                'wt_mt_1d_e1_meanratio','wt_mt_1d_e1_sdev',...
                'wt_mt_7d_e1_meanratio','wt_mt_7d_e1_sdev',...
                'wt_mt_21d_e1_meanratio','wt_mt_21d_e1_sdev'};
...
%%% SECOND TABLE 
% read in table
ratio_e2 = readtable('WTMT_ratio_mets_0d1d7d21d_e2.csv');
% save names
metnames = ratio_e2(:,1);
summarynames = {'wt_mt_0d_e2_meanratio','wt_mt_0d_e2_sdev',...
                'wt_mt_1d_e2_meanratio','wt_mt_1d_e2_sdev',...
                'wt_mt_7d_e2_meanratio','wt_mt_7d_e2_sdev',...
                'wt_mt_21d_e2_meanratio','wt_mt_21d_e2_sdev'};
...
%%% THIRD TABLE 
% read in table
ratio_e1e2 = readtable('WTMT_ratio_mets_0d1d7d21d_e1e2.csv');
% save names
metnames = ratio_e1e2(:,1);
summarynames = {'wt_mt_0d_e1e2_meanratio','wt_mt_0d_e1e2_sdev',...
                'wt_mt_1d_e1e2_meanratio','wt_mt_1d_e1e2_sdev',...
                'wt_mt_7d_e1e2_meanratio','wt_mt_7d_e1e2_sdev',...
                'wt_mt_21d_e1e2_meanratio','wt_mt_21d_e1e2_sdev'};
...
%%% WRITE TABLES  
writetable(ratio_e1_mean_sdev,'WTMT_ratio_mets_e1_mean_sdev.txt');
writetable(ratio_e2_mean_sdev,'WTMT_ratio_mets_e2_mean_sdev.txt');
writetable(ratio_e1e2_mean_sdev,'WTMT_ratio_mets_e1e2_mean_sdev.txt');
...
% write tables 
writetable(testratio,'WTMT_ratio_mets_e1_mean_sdev_sorted.txt');
writetable(testdic,'WTMT_ratio_mets_dictionary_e1_sorted.txt');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
testdic = cell2table(testdic);
% write tables 
writetable(testratio,'WTMT_ratio_mets_e2_mean_sdev_sorted.txt');
writetable(testdic,'WTMT_ratio_mets_dictionary_e2_sorted.txt');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
testdic = cell2table(testdic);
% write tables 
writetable(testratio,'WTMT_ratio_mets_e1e2_mean_sdev_sorted.txt');
writetable(testdic,'WTMT_ratio_mets_dictionary_e1e2_sorted.txt');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% use sorted tables for the final run in iremetflux 
...
order both tables so that everz idx is the same metabolite +
remove unneccasary stuff +
find indecies of nan rows 
remove idecies with na idxs of table in dic 
